...
function Navbar() {
  ...
  return (
    <nav className="bg-white p-4 border-b border-gray-200 shadow-md">
      <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-0">
        <div className="relative flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-4">
            <a href="/search" className="text-gray-700 hover:text-black">
              <svg
                fill="currentColor"
                viewBox="0 0 16 16"
                height="1.5em"
            ...
            <a href="/favorites" className="text-gray-700 hover:text-black">
              <svg
